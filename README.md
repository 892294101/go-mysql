...
![semver](https://img.shields.io/github/v/tag/892294101/go-mysql)
![example workflow](https://github.com/892294101/go-mysql/actions/workflows/ci.yml/badge.svg)
![gomod version](https://img.shields.io/github/go-mod/go-version/892294101/go-mysql/master)

## How to migrate to this repo
To change the used package in your repo it's enough to add this `replace` directive to your `go.mod`:
```
replace github.com/siddontang/go-mysql => github.com/892294101/go-mysql v1.6.0
```
